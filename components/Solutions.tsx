...
const capabilities = [
  ...
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1 1 .03 2.71-1.407 2.71H4.205c-1.437 0-2.407-1.71-1.407-2.71L5 14.5" />
      </svg>
    ),
    ...
    <section id="solutions" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          <p className="text-xs font-semibold tracking-widest uppercase text-brand-500 mb-3">Platform Capabilities</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {capabilities.map((cap, i) => (
            <div
              key={cap.title}
              className="card-hover bg-white rounded-2xl p-6 border border-gray-100 cursor-pointer relative overflow-hidden"
              onMouseEnter={() => setActive(i)}
            >
              {cap.badge && (
                <span className="absolute top-4 right-4 text-xs font-semibold bg-brand-50 text-brand-600 px-2 py-0.5 rounded-full">
                  {cap.badge}
                </span>
              )}
              <div className={`w-11 h-11 rounded-xl ${cap.color} flex items-center justify-center mb-4`}>
                {cap.icon}
              </div>
              <h3 className="font-display font-bold text-gray-900 text-base mb-2">{cap.title}</h3>
              <p className="text-sm text-gray-600 leading-relaxed">{cap.desc}</p>
              <button className="mt-4 text-xs font-semibold text-brand-600 flex items-center gap-1 hover:gap-2 transition-all">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 mb-4 text-sm">Ready to see it all in action?</p>
          <a
            href="#contact"
            className="inline-flex items-center gap-2 bg-brand-500 hover:bg-brand-600 text-white font-semibold px-7 py-3 rounded-xl transition-all hover:shadow-xl hover:shadow-brand-500/25"
          >
